    ...
    try:
        ...
        for item in stocks:
            ...
            registros.append({
                ...
                "quantidade_acoes": item.get("shares"), # <-- NOVO: Salva a qtd de ações
                "ativo": True,
            })
        ...
        registrar_carga(
            ...
            mensagem=f"{len(registros)} empresas carregadas. {ignoradas} ignoradas."
        )
        print(f"✅ Válidas: {len(registros)} | Ignoradas: {ignoradas}")
